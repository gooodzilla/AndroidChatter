...
define("SUCCESSFUL", 1);
// когда регистрируемся и имя пользователя существует
define("SIGN_UP_USERNAME_CRASHED", 2);  
// когда добавляем друга но его не существует
...
//если авторизация	
	case "authenticateUser":
		...
		{					
			...
			// providerId and requestId это id пары друзей
			// providerId делает запрос на друга
			// requestId тот кто принимает запрос
